...
export function MasterTraderSection() {
  ...
  return (
    <section id="traders" className="relative py-24 lg:py-32 bg-surface-0" ref={ref}>
          ...
          >
            <div className="bg-white border border-border rounded-2xl overflow-hidden shadow-card-lg">
              ...
              <div className="px-6 py-4 border-b border-border flex items-center justify-between">
                <span className="text-xs font-semibold text-text-secondary">Master Trader Dashboard</span>
              ...
              <div className="grid grid-cols-3 divide-x divide-border">
                {[
                  ...
                  { label: "Followers", value: "127", color: "text-text-primary" },
                  { label: "Win Rate", value: "72.4%", color: "text-text-primary" },
                ].map((stat, i) => (
                  <div key={i} className="px-6 py-4">
                    <p className="text-2xs font-medium text-text-secondary mb-1">{stat.label}</p>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between px-6 py-3.5">
                    ...
                    <div className="flex items-center gap-5">
                      <span className="text-xs font-mono text-text-secondary">${signal.price}</span>
